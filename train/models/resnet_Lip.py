...
class ResNetEmbedLip(nn.Module):
    def __init__(self,block,num_blocks,mod=True,coeff=None,n_power_iterations=1):
        """
        ...
        """
        super(ResNetEmbedLip, self).__init__()
        self.in_planes = 64
...
def resnet18(classifier, coeff=None, mod=False, **kwargs):
    ...
    return ResNetLip(embed,classifier)
