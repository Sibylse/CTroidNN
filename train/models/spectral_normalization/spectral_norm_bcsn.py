...
Soft Batch Spectral Normalization (not enforced, only <= coeff) for Conv2D layers
...
class SpectralNormBSN(object):
    ...
    def apply(module, coeff, input_dim, name, n_power_iterations, eps):
        #module is sequential module, module[0] is conv2d and module[1] is batchnorm2d
        for k, hook in module._forward_pre_hooks.items():
            if isinstance(hook, SpectralNormBCSN) and hook.name == name:
